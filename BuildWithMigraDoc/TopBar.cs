...
public class TopBar
{
    ...
    private void CreatePage()
    {
        ...
        _section.PageSetup.PageWidth = Unit.FromCentimeter(19);
        ...
        paragraph.AddText("This is Topbar");
        paragraph.Format.Font.Size = 18;

        paragraph = _section.AddParagraph();
        paragraph.AddText("This is Title bar");
        paragraph.Format.Font.Size = 18;

        paragraph = _section.AddParagraph();
        paragraph.AddText("This is Sub Title bar");
